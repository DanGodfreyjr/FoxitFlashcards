...
BEGIN_MESSAGE_MAP(quizBox, CDialogEx)
	ON_BN_CLICKED(IDC_BUTTON1, &quizBox::OnBnClickedButton1)
	ON_EN_CHANGE(IDC_EDIT1, &quizBox::OnEnChangeEdit1)
	ON_BN_CLICKED(IDC_BUTTON2, &quizBox::OnBnClickedButton2)
	ON_BN_CLICKED(IDC_BUTTON3, &quizBox::OnBnClickedButton3)
END_MESSAGE_MAP()
...
void quizBox::OnBnClickedButton3()
{
	// TODO: Add your control notification handler code here
	this->nextCard();
}
